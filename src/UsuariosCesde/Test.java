...
public class Test {
    public static void main(String[] args) {
        ...
        */
        ...
        Usuario estSiftware = new Estudiante();
        ((Estudiante)estSiftware).setCarrera("Diseño");
        System.out.println(((Estudiante) estSiftware).getCarrera());


        Usuario enpProfesor = new Empleado();
        //((Empleado)enpProfesor);
